...
class GenEntityController {
    ...
    descricao;
    constructor() {
        this.nome = 'gen-entity';
        this.descricao = 'Crie um novo arquivo C# com uma nova entidade';
    }
    exec(options, path) {
        try {
            const content = gen_entity_service_1.default.generateFileContent(options.fName);
